...
###################################################
### code chunk number 7: RadOnc.Rnw:98-99 (eval = FALSE)
###################################################
## DVHs <- read.DVH(file=c("Jane_Doe.dvh", "John_Doe.dvh"), type="aria10")


###################################################
### code chunk number 8: RadOnc.Rnw:101-103
###################################################
DVHs <- read.DVH(file=paste(system.file("extdata/", package="RadOnc"), c("Jane_Doe.dvh", "John_Doe.dvh"), sep=""), type="aria10")
DVHs
...
###################################################
### code chunk number 10: RadOnc.Rnw:113-114
###################################################
temp <- janedoe


###################################################
### code chunk number 11: RadOnc.Rnw:116-119
###################################################
johndoe[["CTV"]]
...
###################################################
### code chunk number 12: RadOnc.Rnw:121-122
###################################################
janedoe <- temp


###################################################
### code chunk number 13: RadOnc.Rnw:126-128
###################################################
janedoe["KIDNEY$"]
janedoe[c(2,"IGHT.*")]
...
###################################################
### code chunk number 14: RadOnc.Rnw:133-137
###################################################
...
###################################################
### code chunk number 15: RadOnc.Rnw:139-140
###################################################
janedoe <- temp


###################################################
### code chunk number 16: RadOnc.Rnw:144-146
###################################################
...
###################################################
### code chunk number 17: RadOnc.Rnw:153-157
###################################################
...
###################################################
### code chunk number 18: RadOnc.Rnw:160-162
###################################################
...
###################################################
### code chunk number 19: RadOnc.Rnw:165-166
###################################################
johndoe[["DUODENUM"]][c("V5", "VGy", "volume", 2.5, "", "Dmax%")]


###################################################
### code chunk number 20: RadOnc.Rnw:169-170
###################################################
johndoe[["LIVER"]][c("V10Gy(%)","D25%","D25%(Gy)")]


###################################################
### code chunk number 21: RadOnc.Rnw:173-175
###################################################
...
###################################################
### code chunk number 22: RadOnc.Rnw:183-187
###################################################
...
###################################################
### code chunk number 23: RadOnc.Rnw:194-195
###################################################
...
###################################################
### code chunk number 30: RadOnc.Rnw:286-289
###################################################
...
###################################################
### code chunk number 31: RadOnc.Rnw:291-297 (eval = FALSE)
###################################################
## L.kidney <- janedoe[["LEFT_KIDNEY"]]
## R.kidney <- janedoe[["RIGHT_KIDNEY"]]
## total.kidney <- sum(janedoe[c("LEFT_KIDNEY", "RIGHT_KIDNEY")])
...
###################################################
### code chunk number 33: RadOnc.Rnw:313-316
###################################################
...
###################################################
### code chunk number 34: RadOnc.Rnw:321-323 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 36: RadOnc.Rnw:348-349 (eval = FALSE)
###################################################
## data <- read.DICOM.RT(path="<<DICOM directory>>", verbose=TRUE)


###################################################
### code chunk number 37: RadOnc.Rnw:353-354
###################################################
data("RadOnc")


###################################################
### code chunk number 38: RadOnc.Rnw:361-363
###################################################
teeth[1:2]
c(cord, mandible)
...
###################################################
### code chunk number 39: RadOnc.Rnw:365-366
###################################################
temp <- teeth


###################################################
### code chunk number 40: RadOnc.Rnw:368-371
###################################################
teeth[[1]]
...
###################################################
### code chunk number 41: RadOnc.Rnw:373-374
###################################################
teeth <- temp


###################################################
### code chunk number 42: RadOnc.Rnw:378-379
###################################################
teeth["Tooth.*"]


###################################################
### code chunk number 43: RadOnc.Rnw:384-388
###################################################
...
###################################################
### code chunk number 44: RadOnc.Rnw:390-391
###################################################
teeth <- temp


###################################################
### code chunk number 45: fig9 (eval = FALSE)
###################################################
## plot(mandible)
...
###################################################
### code chunk number 47: RadOnc.Rnw:429-430 (eval = FALSE)
###################################################
## compareStructures(teeth, method="axial", plot=TRUE)


###################################################
### code chunk number 48: fig11
###################################################
compareStructures(teeth, method="axial", plot=TRUE, pixels=40)


###################################################
### code chunk number 49: RadOnc.Rnw:442-443
###################################################
teeth <- teeth[c(1,3)]


###################################################
### code chunk number 50: RadOnc.Rnw:445-446
###################################################
compareStructures(teeth, method="hausdorff", hausdorff.method="mean")


###################################################
### code chunk number 51: RadOnc.Rnw:448-449
###################################################
teeth <- temp


###################################################
### code chunk number 52: RadOnc.Rnw:475-476
###################################################
news(package="RadOnc")
